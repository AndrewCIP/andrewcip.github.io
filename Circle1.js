...
export default class Circle1 extends Standard2DVertexObject {
  constructor(device, canvasFormat, xPos = 0, yPos = 0, xScale = 1, yScale = 1, shader = '/lib/Shaders/leaves.wgsl', segments = 32) {
    let vertices = Circle1.generateVertices(xPos, yPos, xScale, yScale, segments);
